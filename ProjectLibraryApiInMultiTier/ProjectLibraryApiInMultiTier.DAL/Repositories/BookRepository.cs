...
namespace ProjectLibraryApiInMultiTier.DAL.Repositories
{
    public class BookRepository : RepositoryBase<int, BookEntity>, IBookRepository
    {
        ...
        {
            Command cmd = new Command($"Select b.Id,b.Title, b.[Resume],b.PublicationDate, b.LanguageId, ba.AuthorId as [auteur] from Book b join BookAuthor ba  on b.Id = ba.BookId where ba.AuthorId=@id");
